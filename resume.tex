...
\item Replaced self-hosted infrastructure with cloud native alternatives a year ahead of schedule.
...
\item Created cross-team best practices committee.
\end{tightemize}
\sectionsep
...
\item Removed direct dependency on Solr for better long term maintainability.
